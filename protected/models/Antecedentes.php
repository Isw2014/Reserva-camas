...
class Antecedentes extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'ant_balance' => 'Ant Balance',
			'ant_cuidadoOxigenoterapia' => 'Ant Cuidado Oxigenoterapia',
			'ant_cuidadoAereo' => 'Ant Cuidado Aereo',
			'ant_intervenciones' => 'Ant Intervenciones',
			'ant_cuidadoPiel' => 'Ant Cuidado Piel',
			'ant_tratamiento' => 'Ant Tratamiento',
			'ant_presenciaElementos' => 'Ant Presencia Elementos',
			'ant_fecha' => 'Ant Fecha',
			'ant_pac_id' => 'Ant Pac',
			'ant_cambioRopa' => 'Ant Cambio Ropa',
			'ant_movilizacion' => 'Ant Movilizacion',
			'ant_cuidadosAlimentacion' => 'Ant Cuidados Alimentacion',
			'ant_cuidadosEliminacion' => 'Ant Cuidados Eliminacion',
			'ant_apoyo' => 'Ant Apoyo',
			'ant_vigilancia' => 'Ant Vigilancia',
		);
	}
